...
description: 'To ensure data is preserved and recoverable in case of corruption, accidental deletion, or catastrophic failure. Use when: Always. For every production database.'
---
