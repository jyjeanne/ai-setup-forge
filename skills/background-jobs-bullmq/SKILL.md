...
description: 'To offload time-consuming tasks (email sending, image processing, report generation) from the main HTTP request-response cycle using Redis-based queues. Use when: When an API request takes longer than a few seconds; To handle rate-limited 3rd party API calls; To retry failed operations automatically.'
---
