...
description: 'To render 2D (Canvas API) or 3D (Three.js/WebGL) graphics in the browser for games, visualizations, or creative effects. Use when: Canvas: Charts, simple games, image editing; Three.js: 3D models, immersive experiences, complex particle systems.'
---
