...
description: 'To systematically review code changes for common security flaws before merging, preventing vulnerabilities from reaching production. Use when: During every Pull Request (PR) review; When auditing legacy code.'
---
