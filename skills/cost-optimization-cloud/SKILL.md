...
description: 'To reduce cloud infrastructure costs. Use when: Spot instances, rightsizing, and budgeting; When the specific requirement for Cost Optimization (AWS/Cloud) arises in the project.'
---
