...
description: 'To provide a color scheme preference (Light/Dark) that respects user system settings and allows manual toggling. Use when: Improving accessibility and reducing eye strain; Modern app aesthetic requirements.'
---
