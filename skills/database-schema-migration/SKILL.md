...
description: 'To safely modify the database schema (tables, columns, indexes) using version-controlled migration files, ensuring consistency across development, staging, and production environments. Use when: When adding new tables or columns; When modifying column types or constraints; When adding indexes for performance.'
---
