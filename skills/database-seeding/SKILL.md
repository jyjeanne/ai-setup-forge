...
description: 'To populate the database with predictable, realistic initial data for development, testing, and staging environments. Use when: When setting up a new developer machine; When running integration tests (resetting state); When initializing a new environment with lookup data (e.g., roles, categories).'
---
