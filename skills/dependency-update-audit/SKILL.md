...
description: 'To regularly check, update, and audit project dependencies for security vulnerabilities and deprecations, maintaining a healthy codebase. Use when: On a scheduled basis (e.g., monthly); When a security advisory is released; Before major feature development cycles.'
---
