...
description: 'To maintain data consistency across multiple microservices where local ACID transactions are not possible. Use when: E-commerce order: Payment Service -> Inventory Service -> Shipping Service; Any operation spanning multiple databases.'
---
