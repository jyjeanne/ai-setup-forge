...
description: 'To implement full-text search, autocomplete, and complex filtering capabilities that standard SQL databases cannot handle efficiently. Use when: Search bars (e-commerce products, user finder); Log analysis; Fuzzy matching (handling typos).'
---
