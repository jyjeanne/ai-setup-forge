...
description: 'To securely store, retrieve, and serve user-uploaded files (images, documents) using Object Storage, separating binary data from the database. Use when: Storing user avatars, post images, or PDFs; When local disk storage is not scalable (e.g., stateless containers).'
---
