...
description: 'To securely accept file uploads from users, validate them, and store them in a durable object storage service (like AWS S3), keeping the application server stateless. Use when: User avatar uploads; Document attachments; Media processing pipelines.'
---
