...
description: 'To manage shared state across the application predictably, avoiding "prop drilling" and complex context hierarchies. Use when: When state is needed by many components at different nesting levels (e.g., User, Theme, Cart); When state logic is complex (many actions updating same data).'
---
