...
description: 'To build high-performance, low-latency inter-service communication using Protocol Buffers and HTTP/2. Use when: Microservices architectures; Internal APIs where low latency is critical; Polyglot environments (services in Go, Java, Python, Node).'
---
