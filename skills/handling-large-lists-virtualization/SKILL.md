...
description: 'To render large datasets (thousands of items) efficiently by only rendering the items currently visible in the viewport (Windowing). Use when: Infinite scroll feeds; Large data tables; Chat history logs.'
---
