...
description: 'To provision and manage infrastructure (servers, databases, networks) using declarative configuration files, ensuring reproducibility and version control. Use when: Setting up a new cloud environment (AWS, Azure, GCP); Managing changes to existing infrastructure; Preventing configuration drift.'
---
