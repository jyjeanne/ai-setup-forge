...
description: 'To validate incoming request data (body, query, params) against a strict schema before processing it, ensuring type safety and data integrity. Use when: When accepting any user input; When defining TypeScript interfaces for API requests; When preventing injection attacks and malformed data issues.'
---
