...
description: 'To adapt the application for users from different languages and regions without code changes. Use when: When the app has a global audience; When supporting multiple languages (English, Spanish, etc.).'
---
