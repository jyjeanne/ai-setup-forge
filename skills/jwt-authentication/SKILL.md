...
description: 'To secure API endpoints by issuing and verifying JSON Web Tokens (JWT) for stateless user authentication in Node.js applications. Use when: When implementing login/signup for SPAs or mobile apps; When you need a stateless way to manage user sessions; When building microservices that need to share user identity.'
---
