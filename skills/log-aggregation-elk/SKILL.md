...
description: 'To centralize logs from all services and containers into a single queryable interface, enabling debugging and trend analysis across the distributed system. Use when: When running multiple microservices or containers; When SSH-ing into servers to check logs is not scalable.'
---
