...
description: 'To decouple heavy or long-running processes from the main HTTP request-response cycle by offloading tasks to an asynchronous background worker. Use when: When sending emails/notifications; When processing video/image uploads; When handling high-throughput event ingestion.'
---
