...
description: 'To add an extra layer of security (Multi-Factor Authentication) using Time-based One-Time Passwords (TOTP). Use when: Protecting sensitive accounts (Admin panels, financial apps); Compliance requirements.'
---
