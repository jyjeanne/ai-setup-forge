...
description: 'To enable reliable and efficient communication between distinct services in a distributed architecture. Use when: Breaking a monolith into services; Connecting a backend to a specialized service (e.g., AI inference, Payment Gateway).'
---
