...
description: 'To access native device hardware capabilities (Camera, Location, Sensors, Biometrics) securely and efficiently in Expo/React Native. Use when: When the app needs to take photos, track user location, or use FaceID; When reading accelerometer or gyroscope data.'
---
