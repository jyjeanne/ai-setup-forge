...
description: 'To design and develop UIs starting with the smallest screen sizes (mobile) and progressively enhancing for larger screens (tablet, desktop). Use when: All responsive web projects; To ensure core content is prioritized.'
---
