...
description: 'To style React Native components using the utility-first CSS framework Tailwind CSS, via the NativeWind library. Use when: When you prefer Tailwind syntax over StyleSheet.create; To share styles/tokens between web and mobile (Universal Apps); To speed up UI development with predefined utility classes.'
---
