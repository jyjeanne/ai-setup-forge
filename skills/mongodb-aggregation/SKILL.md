...
description: 'To perform complex data processing, transformation, and analysis directly within MongoDB using pipelines. Use when: When simple find() queries are insufficient; For grouping, summing, or averaging data (analytics); For joining collections ($lookup).'
---
