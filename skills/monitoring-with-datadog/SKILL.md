...
description: 'To observe system health. Use when: Metrics, dashboards, and alerts; When the specific requirement for Monitoring with Datadog arises in the project.'
---
