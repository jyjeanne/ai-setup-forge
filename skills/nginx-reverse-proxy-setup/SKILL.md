...
description: 'To sit in front of backend applications, handling SSL termination, load balancing, compression, and static file serving. Use when: Exposing a Node.js app to the internet; Hosting multiple domains on one server; Improving security and performance.'
---
