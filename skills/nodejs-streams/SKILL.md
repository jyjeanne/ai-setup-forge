---
name: nodejs-streams
description: 'To handle data efficiently in Node.js by processing it piece-by-piece (chunks) rather than loading everything into memory at once. Use when: Reading/Writing large files (GBs in size); Processing HTTP requests/responses (e.g., video streaming, file uploads); Transformative pipelines (compression, encryption).'
---
