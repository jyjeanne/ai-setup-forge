...
description: 'To design mobile apps that remain fully functional without an internet connection, syncing data when connectivity is restored. Use when: Field service apps (inspections, delivery); Apps used in areas with poor connectivity; To improve perceived performance (optimistic UI).'
---
