...
description: 'To limit the amount of data returned in a single API response, improving performance and user experience when dealing with large lists. Use when: Listing users, products, or orders; Any endpoint returning an array that could grow indefinitely.'
---
