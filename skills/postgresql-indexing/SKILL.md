...
description: 'To optimize database query performance by applying appropriate indexing strategies in PostgreSQL. Use when: When queries are slow (high execution time); When filtering, sorting, or joining on specific columns frequently; To enforce uniqueness constraints.'
---
