...
description: 'To model application data using the Prisma Schema Language (PSL), generating a type-safe client and handling database migrations. Use when: Modern Node.js/TypeScript backends; When preferring a declarative schema over SQL migrations.'
---
