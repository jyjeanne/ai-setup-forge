...
description: 'To collect metrics (CPU, Memory, Request Latency, Error Rates) and alert engineers when the system behaves abnormally. Use when: Production readiness; Capacity planning; Detecting incidents before users report them.'
---
