...
description: 'To apply systematic techniques for crafting inputs (prompts) to Large Language Models (LLMs) to ensure accurate, consistent, and high-quality outputs. This skill focuses on structured prompt management and engineering patterns. Use when: When interacting with LLMs for any task (generation, summarization, extraction); When model outputs are inconsistent, hallucinatory, or vague; When you need to standardize input/output formats for an application.'
---
