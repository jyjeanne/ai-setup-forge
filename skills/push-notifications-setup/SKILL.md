...
description: 'To implement remote push notifications to engage users, using Expo Notifications service (FCM for Android, APNs for iOS). Use when: To inform users of updates, messages, or alerts; To re-engage users who haven''t opened the app recently.'
---
