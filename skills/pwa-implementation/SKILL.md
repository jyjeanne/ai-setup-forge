...
description: 'To convert a web application into a Progressive Web App (PWA) that is installable, works offline, and behaves like a native app. Use when: When you want a mobile presence without developing separate native apps; To improve engagement via "Add to Home Screen".'
---
