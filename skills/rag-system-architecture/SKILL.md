...
description: 'To design and implement a Retrieval-Augmented Generation (RAG) system that grounds LLM responses in specific, external data sources, reducing hallucinations and enabling knowledge on private data. Use when: When the LLM needs to answer questions about proprietary documents (PDFs, internal wikis); When the knowledge base is too large to fit in the context window; When data changes frequently and retraining is not feasible.'
---
