...
description: 'To protect APIs from abuse, brute-force attacks, and DoS attempts by limiting the number of requests a client can make within a specific time window. Use when: When exposing public APIs to the internet; When protecting high-cost endpoints (e.g., AI generation, email sending); When securing login and password reset routes.'
---
