...
description: 'To restrict access to specific API resources based on the user''s assigned role (e.g., Admin, Editor, User). Use when: When different users have different permission levels; When protecting administrative endpoints.'
---
