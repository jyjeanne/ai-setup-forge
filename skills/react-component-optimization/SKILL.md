...
description: 'To improve the rendering performance of React applications by preventing unnecessary re-renders of components. Use when: When a component renders often (e.g., list items, inputs); When a component receives complex props (objects/arrays); When profiling reveals "wasted renders".'
---
