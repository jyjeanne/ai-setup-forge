...
description: 'To implement robust navigation patterns in React Native applications using Expo Router (recommended) or React Navigation. Use when: When the app has multiple screens; When needing tab bars, drawers, or stack navigation (push/pop); When handling deep links.'
---
