...
description: 'To create high-performance, smooth (60fps+) animations and interactions in React Native by running animation logic on the UI thread. Use when: When Animated API from React Native is too slow or stutters; For complex gestures (drag, pinch, swipe); For shared element transitions.'
---
