...
description: 'To test React components by interacting with them as a user would (clicking, typing, reading text), rather than testing implementation details. Use when: Unit and Integration testing of UI components; Ensuring accessibility (finding elements by role).'
---
