...
description: 'To modernize and clean up "fat controllers" by extracting business logic into services, improving readability, and making the code testable. Use when: When a controller file exceeds ~200 lines or handles too many responsibilities; When logic is duplicated across multiple controllers; When unit testing the controller is difficult due to mixed concerns.'
---
