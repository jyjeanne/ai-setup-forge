...
description: 'To create user interfaces that adapt seamlessly to different screen sizes (Mobile, Tablet, Desktop) using a utility-first CSS framework. Use when: Building any user-facing layout; Ensuring mobile compatibility.'
---
