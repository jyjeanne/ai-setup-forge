...
description: 'To restrict access to specific pages (routes) based on user authentication status or roles, redirecting unauthorized users. Use when: Dashboards, settings pages, or any private content; Redirecting logged-in users away from Login/Signup pages.'
---
