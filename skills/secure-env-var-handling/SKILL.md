...
description: 'To manage configuration and sensitive secrets securely, preventing hardcoded credentials and ensuring consistency across environments. Use when: When adding API keys, database URLs, secrets, or configuration flags; When setting up a new project or deployment environment.'
---
