...
description: 'To track application errors. Use when: SDK setup and source maps; When the specific requirement for Sentry Error Tracking Setup arises in the project.'
---
