...
description: 'To deploy serverless apps easily. Use when: serverless.yml configuration; When the specific requirement for Serverless Framework Setup arises in the project.'
---
