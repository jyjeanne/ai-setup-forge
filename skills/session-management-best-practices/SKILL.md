...
description: 'To securely manage user sessions, maintaining state across stateless HTTP requests while preventing hijacking and XSS/CSRF attacks. Use when: Any web application requiring login; Choosing between JWT and Server-side Sessions.'
---
