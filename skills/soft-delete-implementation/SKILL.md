...
description: 'To mark records as deleted without physically removing them from the database, allowing for data recovery and audit trails. Use when: When data is valuable or legally required to be retained; When "deleting" a user account or order.'
---
