...
description: 'To implement robust audio transcription and translation using OpenAI''s Whisper model, handling large files, various formats, and specialized vocabulary. Use when: When converting user voice commands to text in a web/mobile app; When transcribing long-form content (podcasts, meetings); When you need high-accuracy transcription for non-English languages.'
---
