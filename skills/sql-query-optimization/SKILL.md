...
description: 'To improve database performance by writing efficient SQL queries, using indexes correctly, and avoiding common pitfalls like N+1 problems. Use when: When an API endpoint is slow due to database latency; When reviewing database access patterns in code reviews; When dealing with large datasets.'
---
