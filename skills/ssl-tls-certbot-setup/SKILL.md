...
description: 'To secure communication between clients and the server using HTTPS, obtaining free certificates from Let''s Encrypt and automating renewal. Use when: Any public-facing web service; Compliance requirements (PCI-DSS).'
---
