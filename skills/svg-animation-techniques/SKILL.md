...
description: 'To create scalable, crisp animations for icons, logos, and illustrations using CSS or JavaScript libraries. Use when: Loading spinners; Interactive icons (hamburger menu to X); Complex illustrations (paths drawing themselves).'
---
