...
description: 'To automatically generate interactive API documentation that stays up-to-date with the codebase, aiding frontend developers and third-party integrators. Use when: When exposing APIs to other teams or the public; When strictly defining API contracts; When standardizing API development.'
---
