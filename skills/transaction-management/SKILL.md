...
description: 'To ensure data integrity by grouping multiple database operations into a single atomic unit. Either all operations succeed, or none do. Use when: Transferring money (debit A, credit B); Creating an order (create order, create items, update inventory); Any multi-step write operation.'
---
