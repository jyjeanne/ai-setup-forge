...
description: 'To define and manage relationships (One-to-One, One-to-Many, Many-to-Many) between entities in TypeScript applications using TypeORM. Use when: Building a relational backend with Node.js/TypeScript; Need to load related data automatically (Eager) or on demand (Lazy).'
---
