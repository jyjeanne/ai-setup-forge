...
description: 'To create robust unit tests for individual functions, classes, or modules to ensure they behave as expected in isolation. Use when: When writing new business logic or utility functions; When fixing a bug (write a failing test first); When refactoring code to ensure no regressions.'
---
