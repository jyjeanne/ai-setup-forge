...
description: 'To measure and improve Core Web Vitals (LCP, INP, CLS) for better user experience and SEO rankings. Use when: When users complain about slowness; Preparing for a production launch; Continuous monitoring.'
---
