---
name: web-workers
description: 'To run JavaScript in background threads, preventing heavy computations from blocking the UI (Main Thread). Use when: Image processing/filtering; Parsing large JSON/CSV files; Complex cryptographic calculations.'
---
