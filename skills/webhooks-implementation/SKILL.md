...
description: 'To implement a system that pushes real-time event notifications to external subscribers via HTTP POST requests. Use when: Notifying 3rd party integrations of state changes (e.g., "Payment Successful", "Order Shipped"); Reducing polling from clients.'
---
