...
description: 'To enable real-time, bi-directional event-based communication between the client and server. Use when: Chat applications; Live notifications/alerts; Real-time dashboards or collaborative editing.'
---
