...
description: 'To prevent cross-site scripting. Use when: Sanitization and escaping; When the specific requirement for XSS Prevention Guide arises in the project.'
---
